...
Uso: python scraper_segunda_vuelta_provincial.py
"""
...
def api(path, params=None, retries=5):
    """GET a /presentacion-backend/{path} y devuelve data, con reintentos."""
    last_err = None
...
print(f"\n{'=' * 60}")
print(f"  SEGUNDA VUELTA 2026 -- PROYECCION AL 100%")
